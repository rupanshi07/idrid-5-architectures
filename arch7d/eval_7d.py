...
def plot_confusion_matrix(cm, class_names, out_path):
    ...
    ax.set_title("DR Grading -- Arch 7D (shared bottleneck transformer)")
    thresh = cm.max() / 2.0
...
def get_args():
    ...
    p.add_argument("--checkpoint", default="checkpoints_7d/model_best.pth")
    p.add_argument("--cm_out", default="checkpoints_7d/confusion_matrix.png")
    return p.parse_args()
