...
from model_1_simple_unet import JointSegClsNet
...
def plot_confusion_matrix(cm, class_names, out_path):
    ...
    ax.set_title("DR Grading Confusion Matrix -- Architecture 1: Simple U-Net")
    thresh = cm.max() / 2.0
...
def get_args():
    ...
    p.add_argument("--checkpoint", default="checkpoints_1_simple_unet/model_best.pth")
    p.add_argument("--cm_out", default="checkpoints_1_simple_unet/confusion_matrix.png")
    return p.parse_args()
...
def main():
    ...
    print(f"[Architecture 1: Simple U-Net] Using device: {device}")
