...
def plot_confusion_matrix(cm, class_names, out_path):
    ...
    ax.set_title("DR Grading -- Arch 7A v3 (attention-pooling, deep supervision)")
    thresh = cm.max() / 2.0
...
def get_args():
    ...
    p.add_argument("--checkpoint", default="checkpoints_7a_v3/model_best.pth")
    p.add_argument("--cm_out", default="checkpoints_7a_v3/confusion_matrix.png")
    return p.parse_args()
