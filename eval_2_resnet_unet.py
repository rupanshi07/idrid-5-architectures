...
def plot_confusion_matrix(cm, class_names, out_path):
    ...
    ax.set_title("DR Grading Confusion Matrix -- Architecture 2: ResNet + U-Net")
    thresh = cm.max() / 2.0
...
def get_args():
    ...
    p.add_argument("--checkpoint", default="checkpoints_2_resnet_unet/model_best.pth")
    p.add_argument("--cm_out", default="checkpoints_2_resnet_unet/confusion_matrix.png")
    return p.parse_args()
