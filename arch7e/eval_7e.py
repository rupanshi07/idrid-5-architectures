...
def plot_confusion_matrix(cm, class_names, out_path):
    ...
    ax.set_title("DR Grading -- Arch 7E (7A-v3 + Bottleneck Transformer)")
    thresh = cm.max() / 2.0
...
def get_args():
    ...
    p.add_argument("--checkpoint", default="checkpoints_7e/model_best.pth")
    p.add_argument("--cm_out", default="checkpoints_7e/confusion_matrix.png")
    return p.parse_args()
